...
<body>
    ...
    <ul>
      ...
      <li><a href="nyx.php" style="color:#52D017">NYX</a></li>
      <li><a href="lakme.php">Lakme</a></li>
    </ul>

    <h1 style="text-align: center; color:white">NYX</h1>
  ...
  <?php
    ...
    <?php
        ...
        $product= mysqli_query($connect,"SELECT * FROM product WHERE brand='NYX' ");
