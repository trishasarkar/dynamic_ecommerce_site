...
<body>
    ...
    <ul>
      <li><a href="mac.php" style="color:#52D017">MAC</a></li>
      <li><a href="may.php">Maybelline</a></li>
      <li><a href="nyx.php" >NYX</a></li>
      <li><a href="lakme.php">Lakme</a></li>
    </ul>

    <h1 style="text-align: center; color:white">M.A.C</h1>
    <p style="margin-left: 680px; color:white; font-size:18px">-Be BOLD. Be GLAMOROUS.
  ...
  <?php
    ...
    <?php
        ...
        $product= mysqli_query($connect,"SELECT * FROM product WHERE brand='MAC' ");
