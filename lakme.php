...
<body>
    ...
    <ul>
      ...
      <li><a href="lakme.php" style="color:#52D017">Lakme</a></li>
    </ul>

    <h1 style="text-align: center; color:white">LAKME</h1>
  ...
  <?php
    ...
    <?php
        ...
        $product= mysqli_query($connect,"SELECT * FROM product WHERE brand='LAKME' ");
