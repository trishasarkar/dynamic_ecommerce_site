...
<body>
    ...
    <ul>
      ...
      <li><a href="may.php" style="color:#52D017">Maybelline</a></li>
      <li><a href="nyx.php" >NYX</a></li>
      <li><a href="lakme.php">Lakme</a></li>
    </ul>

    <h1 style="text-align: center; color:white">Maybelline New York</h1>
  ...
  <?php
    ...
    <?php
        ...
        $product= mysqli_query($connect,"SELECT * FROM product WHERE brand='MAY' ");
